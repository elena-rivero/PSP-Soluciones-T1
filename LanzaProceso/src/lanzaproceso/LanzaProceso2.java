...
//    File directorio = new File("D:\\Servicios\\LanzaProceso\\bin");
...
//    pb.inheritIO();
		...
		try {
			...
			/*
			 * Se espera a que termine la ejecución del proceso hijo y se obtiene el código
			 * de retorno. Si durante la espera se interrumple la ejecución del programa, se
			 * lanzaría una excepción de tipo InterruptedException. Este programa la
			 * capturaría y la informaría.
			 */
